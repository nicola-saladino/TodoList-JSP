		...
		<main class="form-signin w-100 m-auto">
			<form method="post" action="registrazione">
				...
				<div class="form-floating">
					<input type="text" class="form-control mt-2" id="nome" placeholder="nome" name="nome"> 
					<label for="floatingInput">Nome</label>
				</div>
				<div class="form-floating">
					<input type="text" class="form-control mt-2" id="cognome" placeholder="cognome" name="cognome"> 
				...
				<button class="w-100 btn btn-lg mt-2 btn-registrazione" type="submit" style="background-color: #e07a5f; color: #fff; ">Invia i dati</button>
			</form>
		</main>
	</body>
</html>